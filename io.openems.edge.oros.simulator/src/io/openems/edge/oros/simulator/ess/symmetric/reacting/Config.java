...
@ObjectClassDefinition(//
		...
		description = "This simulates a 'reacting' symmetric Energy Storage System backed by separate BMS and PCS simulators.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "OROS Simulator ESS Symmetric Reacting [{id}]";
}
