...
public interface RuntimeComponent extends OpenemsComponent {
	...
	enum ChannelId implements io.openems.edge.common.channel.ChannelId {
		CUMULATED_TIME_OK_STATE(Doc.of(INTEGER)
				...
				.text("Accumulated time the system spent in the OK state")),
		CUMULATED_TIME_INFO_STATE(Doc.of(INTEGER)
				.unit(CUMULATED_SECONDS)
				.text("Accumulated time the system spent in info state")),
		CUMULATED_TIME_WARNING_STATE(Doc.of(INTEGER)
				.unit(CUMULATED_SECONDS)
				.text("Accumulated time the system spent in warning state")),
		CUMULATED_TIME_FAULT_STATE(Doc.of(INTEGER)
				.unit(CUMULATED_SECONDS)
				.text("Accumulated time the system spent in fault state")),
		;
	 ...
	 * {@link ChannelId#CUMULATED_TIME_OK_STATE}.
	 *
	 * @return the Channel
	 */
	...
	/**
	 * Gets the Channel for
	 * {@link ChannelId#CUMULATED_TIME_INFO_STATE}.
	 *
	 * @return the Channel
	 */
	...
	/**
	 * Gets the Channel for
	 * {@link ChannelId#CUMULATED_TIME_WARNING_STATE}.
	 *
	 * @return the Channel
	 */
	...
	/**
	 * Gets the Channel for
	 * {@link ChannelId#CUMULATED_TIME_FAULT_STATE}.
	 *
	 * @return the Channel
	 */
