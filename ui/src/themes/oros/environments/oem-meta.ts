...
export const OemMeta: BaseMeta = {
    ...
    images: {
        ...
        LOGO: {
            // The version query busts browser caches because the file name carries no content hash.
            DARK: "oros-logo-white-text.svg?v=2",
            LIGHT: "oros-logo-black-text.svg?v=2",
        },
        HEAT: {
            ASKOMA: {
