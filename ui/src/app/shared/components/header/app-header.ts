// @ts-strict-ignore
import { AfterViewChecked, ChangeDetectorRef, Component, effect, inject, Input, OnDestroy, OnInit, signal, untracked, ViewChild, ChangeDetectionStrategy, } from "@angular/core";
