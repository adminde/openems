...
public class PredictorManagerImpl extends AbstractOpenemsComponent implements PredictorManager, OpenemsComponent {
	...
	private Prediction getPredictionSum(Sum.ChannelId channelId) {
		...
		case CONSUMPTION_ACTIVE_ENERGY, //
				...
				HEATING_ACTIVE_POWER, HEATING_ACTIVE_POWER_L1, HEATING_ACTIVE_POWER_L2, HEATING_ACTIVE_POWER_L3,
				HEATING_ACTIVE_CONSUMPTION_ENERGY, HEATING_THERMAL_POWER, HEATING_THERMAL_ENERGY,

				TESS_SOC, TESS_CAPACITY, TESS_THERMAL_POWER, TESS_THERMAL_CHARGE_ENERGY,
				TESS_THERMAL_DISCHARGE_ENERGY,
