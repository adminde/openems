...
public class ChannelFilter {
	...
	public static ChannelFilter from(String[] blacklistedChannelAddresses, String[] blacklistedChannelIds) {
		return new ChannelFilter(//
				Set.copyOf(Arrays.asList(blacklistedChannelAddresses)), //
				Set.copyOf(Arrays.asList(blacklistedChannelIds)));
	}

	private final Set<String> blacklistedChannelAddresses;
	private final Set<String> blacklistedChannelIds;

	private ChannelFilter(Set<String> blacklistedChannelAddresses, Set<String> blacklistedChannelIds) {
