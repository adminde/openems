...
public class EssClusterImpl extends AbstractOpenemsComponent implements EssCluster,
	...
	private final List<EnergyStorageSystem> esss = new CopyOnWriteArrayList<>();
	...
	protected synchronized void removeEss(EnergyStorageSystem ess) {
	 ...
	 */
	protected static int calculateMinPowerPrecision(List<EnergyStorageSystem> esss) {
