...
public interface RctCessMeter extends
	...
	private static void calculateL1PowersFromVoltageAndCurrent(RctCessMeter meter) {
		SymmetricComponent._calculatePhasePowersFromVoltageAndCurrent(meter, meter.getPowerFactorL1Channel(),
	...
	private static void calculateL2PowersFromVoltageAndCurrent(RctCessMeter meter) {
		SymmetricComponent._calculatePhasePowersFromVoltageAndCurrent(meter, meter.getPowerFactorL2Channel(),
	...
	private static void calculateL3PowersFromVoltageAndCurrent(RctCessMeter meter) {
		SymmetricComponent._calculatePhasePowersFromVoltageAndCurrent(meter, meter.getPowerFactorL3Channel(),
