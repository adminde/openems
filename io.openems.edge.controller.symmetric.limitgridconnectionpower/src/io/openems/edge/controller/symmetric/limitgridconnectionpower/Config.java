...
@ObjectClassDefinition(//
		name = "Controller Symmetric Limit Grid-Connection Power", //
...
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Controller Symmetric Limit Grid-Connection Power [{id}]";
}
