...
@ObjectClassDefinition(
		name = "HyperStrong HyperCube II ESS",
...
public @interface Config {
	...
	String alias() default "HyperCube II 0";
	...
	String webconsole_configurationFactory_nameHint() default "HyperStrong HyperCube II ESS [{id}]";
