...
/**
 * Multi-tenant {@link ChannelManager}: resolves channels through the
 * {@code edge} dimension table, so the same database can hold data for many
 * edges (tenant = edge).
 */
public class MultiTenantChannelManager extends ChannelManager {
