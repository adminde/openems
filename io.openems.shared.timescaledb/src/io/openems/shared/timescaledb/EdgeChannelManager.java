...
/**
 * Single-edge {@link ChannelManager}: the local Edge database stores data for
 * exactly one edge, so there is no {@code edge} dimension table and the edge
 * name passed in is ignored. Components are keyed by name alone.
 */
public class EdgeChannelManager extends ChannelManager {
